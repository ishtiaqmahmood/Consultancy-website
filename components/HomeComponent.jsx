        ...
        <div className="container">
          <div className="row align-items-center min-vh-md-75 mt-7">
            <div className="col-md-7 col-lg-6 py-6 text-sm-start text-center">
              <h1 className="mt-6 mb-sm-4 display-4 fw-light lh-sm fs-4 fs-lg-6 fs-xxl-7">
                We Help to <span className="text-primary">Build</span>
                <br className="d-block d-lg-none d-xl-block" />
                Your Dream{" "}
              </h1>
              <p className="mb-5 fs-1 lh-lg">
                We are always availed to consult on taking your higher education
                to the next level so you can stay competitive in the global
                world.
              </p>
              <a className="btn btn-lg btn-primary hover-top btn-glow" href="#">
                Apply Online
                <svg
              ...
              <div className="mt-5 mt-xl-6">
                <ul className="list-unstyled list-inline mb-0">
                  ...
                  <li className="list-inline-item me-3">
                    <a href="#!">
                      <svg
                        className="bi bi-instagram text-instagram text-youtube"
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
                        fill="currentColor"
